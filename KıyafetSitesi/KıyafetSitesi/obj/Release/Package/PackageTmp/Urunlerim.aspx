<%@ Page Title="" Language="C#" MasterPageFile="~/AdminSayfasi.Master" AutoEventWireup="true" CodeBehind="Urunlerim.aspx.cs" Inherits="KıyafetSitesi.Urunlerim" %>
                    ...
                    <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
                        <div class="d-flex flex-wrap flex-md-nowrap mb-6">
                            <div class="mr-0 mr-md-auto">
                                <h2 class="mb-0 text-heading fs-22 lh-15">My Properties<span class="badge badge-white badge-pill text-primary fs-18 font-weight-bold ml-2">29</span>
                                </h2>
                            ...
                            <table class="table table-hover bg-white border rounded-lg">
                                ...
                                <tbody>
                                    ...
                                    <tr class="shadow-hover-xs-2 bg-hover-white">
                                        ...
                                        <td class="align-middle">30 December, 2019</td>
                                        <td class="align-middle">
                                            <span class="badge text-capitalize font-weight-normal fs-12 badge-pink">published</span>
                                        </td>
                                        <td class="align-middle">2049</td>
                                        <td class="align-middle">
                                            <a href="#" data-toggle="tooltip" title="Edit" class="d-inline-block fs-18 text-muted hover-primary mr-5"><i class="fal fa-pencil-alt"></i></a>
                                    ...
                                    <tr class="shadow-hover-xs-2 bg-hover-white">
                                        ...
                                        <td class="align-middle">30 December, 2019</td>
                                        <td class="align-middle">
                                            <span class="badge text-capitalize font-weight-normal fs-12 badge-pink">processing</span>
                                        </td>
                                        <td class="align-middle">2049</td>
                                        <td class="align-middle">
                                            <a href="#" data-toggle="tooltip" title="Edit" class="d-inline-block fs-18 text-muted hover-primary mr-5"><i class="fal fa-pencil-alt"></i></a>
